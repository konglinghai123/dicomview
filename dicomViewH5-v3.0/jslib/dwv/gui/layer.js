...
dwv.html.Layer = function(canvas)
{
     ...
     */
    this.setImageData = function(data,isrotate)
    {
        if(!isrotate){
            imageData = data;
        }else{
            ...
            imageDataVRevert(data,imageData2);
     ...
     */
    this.draw = function (x,y,isrotate,width,height)
    {
        ...
        if(width){
            context.drawImage( cacheCanvas, x||0,y||0,width,height);
        }else{
            context.drawImage( cacheCanvas, x||0,y||0);
        }
    };

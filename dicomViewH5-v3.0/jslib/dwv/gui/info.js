        ...
        if (pos === "bc" || pos === "tc" ||
            ...
            for (var n=0; overlays[n]; n++){
                ...
                if (overlays[n].value === "window-center") {
                    ...
                    ul.appendChild(li);
                } else if (overlays[n].value === "series") {
                    li = document.createElement("li");
                    li.className = "info-" + pos + "-series";
                    ul.appendChild(li);
                } else if (overlays[n].value === "picquality") {
                    li = document.createElement("li");
                    li.className = "info-" + pos + "-picquality";
                    ul.appendChild(li);
                }else if (overlays[n].value === "position") {
                    li = document.createElement("li");
                    li.className = "info-" + pos + "-position";
                    ul.appendChild(li);
                } else if (overlays[n].value === "position-fps") {
                    li = document.createElement("li");
                    li.className = "info-" + pos + "-fps";
                    ul.appendChild(li);
                ...
                if (overlays[n].value === "window-center") {
                    if (event.type === "wl-change") {
                        ...
                        if(typeof li != "undefined"){
                            ...
                            var wcStr = dwv.utils.replaceFlags2( overlays[n].format, [Math.round(event.wc),Math.round(event.ww)] );
                    ...
                    if (event.type === "zoom-change") {
                        ...
                        if(typeof li != "undefined"){
                            dwv.html.cleanNode(li);
                            var zoom = Number(event.scale).toPrecision(4);
                    ...
                    if (event.type === "position-change") {
                        li = div.getElementsByClassName("info-" + pos + "-series")[0];
                        if(typeof li != "undefined"){
                            dwv.html.cleanNode(li);
                            var wwStr2 = dwv.utils.replaceFlags2( overlays[n].format, [app.getSeries()] );
                            li.appendChild( document.createTextNode(wwStr2) );
                        }
                    }
                }else if (overlays[n].value === "picquality") {
                    if (event.type === "position-change") {
                        li = div.getElementsByClassName("info-" + pos + "-picquality")[0];
                        if(typeof li != "undefined"){
                            dwv.html.cleanNode(li);
                            var wwStr2 = dwv.utils.replaceFlags2( overlays[n].format, [app.getPicQuality()] );
                            li.appendChild( document.createTextNode(wwStr2) );
                        }
                    }
                } else if (overlays[n].value === "position") {
                    if (event.type === "position-change") {
                        ...
                        if(typeof li != "undefined"){
                            dwv.html.cleanNode(li);
                            var posStr2 = dwv.utils.replaceFlags2( overlays[n].format, [event.k+1,app.getInstanceNum()] );
                            li.appendChild( document.createTextNode( posStr2 ) );
                        }
                    }
                }  else if (overlays[n].value === "position-fps") {
                    if (event.type === "position-change") {
                        li = div.getElementsByClassName("info-" + pos + "-fps")[0];
                        if(typeof li != "undefined"){
                            dwv.html.cleanNode(li);
                            var posStr = dwv.utils.replaceFlags2( overlays[n].format, [app.getViewController().getFpsSpeed()] );
